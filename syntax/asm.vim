...
syn match asmIdentifier     "\<adc\>"
syn match asmIdentifier     "\<and\>"
syn match asmIdentifier     "\<asl\>"
syn match asmIdentifier     "\<bbr0\>"
syn match asmIdentifier     "\<bbr1\>"
syn match asmIdentifier     "\<bbr2\>"
syn match asmIdentifier     "\<bbr3\>"
syn match asmIdentifier     "\<bbr4\>"
syn match asmIdentifier     "\<bbr5\>"
syn match asmIdentifier     "\<bbr6\>"
syn match asmIdentifier     "\<bbr7\>"
syn match asmIdentifier     "\<bbs0\>"
syn match asmIdentifier     "\<bbs1\>"
syn match asmIdentifier     "\<bbs2\>"
syn match asmIdentifier     "\<bbs3\>"
syn match asmIdentifier     "\<bbs4\>"
syn match asmIdentifier     "\<bbs5\>"
syn match asmIdentifier     "\<bbs6\>"
syn match asmIdentifier     "\<bbs7\>"
syn match asmIdentifier     "\<bcc\>"
syn match asmIdentifier     "\<bcs\>"
syn match asmIdentifier     "\<beq\>"
syn match asmIdentifier     "\<bit\>"
syn match asmIdentifier     "\<bmi\>"
syn match asmIdentifier     "\<bne\>"
syn match asmIdentifier     "\<bpl\>"
syn match asmIdentifier     "\<bra\>"
syn match asmIdentifier     "\<brk\>"
syn match asmIdentifier     "\<bvc\>"
syn match asmIdentifier     "\<bvs\>"
syn match asmIdentifier     "\<clc\>"
syn match asmIdentifier     "\<cld\>"
syn match asmIdentifier     "\<cli\>"
syn match asmIdentifier     "\<clv\>"
syn match asmIdentifier     "\<cmp\>"
syn match asmIdentifier     "\<cpx\>"
syn match asmIdentifier     "\<cpy\>"
syn match asmIdentifier     "\<dec\>"
syn match asmIdentifier     "\<dex\>"
syn match asmIdentifier     "\<dey\>"
syn match asmIdentifier     "\<eor\>"
syn match asmIdentifier     "\<inc\>"
syn match asmIdentifier     "\<inx\>"
syn match asmIdentifier     "\<iny\>"
syn match asmIdentifier     "\<jmp\>"
syn match asmIdentifier     "\<jsr\>"
syn match asmIdentifier     "\<lda\>"
syn match asmIdentifier     "\<ldx\>"
syn match asmIdentifier     "\<ldy\>"
syn match asmIdentifier     "\<lsr\>"
syn match asmIdentifier     "\<nop\>"
syn match asmIdentifier     "\<ora\>"
syn match asmIdentifier     "\<pha\>"
syn match asmIdentifier     "\<php\>"
syn match asmIdentifier     "\<phx\>"
syn match asmIdentifier     "\<phy\>"
syn match asmIdentifier     "\<pla\>"
syn match asmIdentifier     "\<plp\>"
syn match asmIdentifier     "\<plx\>"
syn match asmIdentifier     "\<ply\>"
syn match asmIdentifier     "\<rmb0\>"
syn match asmIdentifier     "\<rmb1\>"
syn match asmIdentifier     "\<rmb2\>"
syn match asmIdentifier     "\<rmb3\>"
syn match asmIdentifier     "\<rmb4\>"
syn match asmIdentifier     "\<rmb5\>"
syn match asmIdentifier     "\<rmb6\>"
syn match asmIdentifier     "\<rmb7\>"
syn match asmIdentifier     "\<rol\>"
syn match asmIdentifier     "\<ror\>"
syn match asmIdentifier     "\<rti\>"
syn match asmIdentifier     "\<rts\>"
syn match asmIdentifier     "\<sbc\>"
syn match asmIdentifier     "\<sec\>"
syn match asmIdentifier     "\<sed\>"
syn match asmIdentifier     "\<sei\>"
syn match asmIdentifier     "\<smb0\>"
syn match asmIdentifier     "\<smb1\>"
syn match asmIdentifier     "\<smb2\>"
syn match asmIdentifier     "\<smb3\>"
syn match asmIdentifier     "\<smb4\>"
syn match asmIdentifier     "\<smb5\>"
syn match asmIdentifier     "\<smb6\>"
syn match asmIdentifier     "\<smb7\>"
syn match asmIdentifier     "\<sta\>"
syn match asmIdentifier     "\<stp\>"
syn match asmIdentifier     "\<stx\>"
syn match asmIdentifier     "\<sty\>"
syn match asmIdentifier     "\<stz\>"
syn match asmIdentifier     "\<tax\>"
syn match asmIdentifier     "\<tay\>"
syn match asmIdentifier     "\<trb\>"
syn match asmIdentifier     "\<tsb\>"
syn match asmIdentifier     "\<tsx\>"
syn match asmIdentifier     "\<txa\>"
syn match asmIdentifier     "\<txs\>"
syn match asmIdentifier     "\<tya\>"
syn match asmIdentifier     "\<wai\>"

syn match asmLabel		"[a-z_][a-z0-9_]*:"he=e-1

syn match asmSpecial		"=\||\|+"
syn match asmDelimiter		"#\|@"
...
syn match asmHexadecimal	"$[0-9a-fA-F]\+" display
syn match asmBinary		"%[0-1]\+"	 display
