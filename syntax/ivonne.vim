...
" storage types
syn match asmType "u8"
syn match asmType "i8"
syn match asmType "u16"
syn match asmType "i16"
syn match asmType "u32"
syn match asmType "i32"
syn match asmType "u64"
syn match asmType "i64"

syn match e1Keyword "proc."
syn match e1Keyword "end."
syn match e1Keyword "block."
syn match e1Keyword "loop."
syn match e1Keyword "goto."
syn match e1Keyword "return."
syn match e1Keyword "if."
syn match e1Keyword "else."
syn match e1Keyword "elif."
syn match e1Keyword "while."
syn match e1Keyword "\<const\>"
syn match e1Keyword "\<static\>"
syn match e1Keyword "\<mut\>"
syn match e1Keyword "\<atomic\>"
...
hi def link e1Keyword		Keyword

let b:current_syntax = "ivonne"
